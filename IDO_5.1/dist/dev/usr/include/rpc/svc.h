...
extern void	svckudp_dupdone(struct svc_req *, caddr_t, int);
extern int	svckudp_dup(struct svc_req *, caddr_t, int);
extern int	svckudp_dupsave(struct svc_req *, int);
