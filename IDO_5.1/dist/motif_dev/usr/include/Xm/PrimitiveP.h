 ...
 * Motif Release 1.2.1
*/ 
/*   $RCSfile: PrimitiveP.h,v $ $Revision: 1.7 $ $Date: 1993/05/25 03:56:54 $ */
/*
...
externalref XmPrimitiveClassRec xmPrimitiveClassRec;
  ...
  {
    Boolean			sg_test1; /* Test resource #1 */
    Boolean			sg_test2; /* Test resource #2 */
    int				int1;     /* Per-instance data #1 */
  } _SG_XmPrimitiveExtPart;

  typedef struct __SG_XmPrimitiveExt
  {
    _SgInstanceExtensionRec	common;   /* Stuff all instance rec's have */
    _SG_XmPrimitiveExtPart	rsrc;	  /* Resources & instance var's */
