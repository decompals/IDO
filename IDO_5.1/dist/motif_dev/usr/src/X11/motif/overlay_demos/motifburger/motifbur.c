...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: motifbur.c,v $ $Revision: 1.3 $ $Date: 1993/01/31 21:50:51 $"
#endif
#endif
/*
...
#ifdef __sgi /* use proper arguments for progname and class */
    display = XtOpenDisplay(app_context, NULL, progname, "example",
                            NULL, 0, &argc, argv);
#else /* OSF Original */
...
#ifdef __sgi /* use proper arguments for progname*/
#ifdef OVERLAY_DEMO
    SG_getOverlayArgs (display, NULL, arglist, &n);
#endif /* OVERLAY_DEMO */
    toplevel_widget = XtAppCreateShell(progname, "Motifbur",
