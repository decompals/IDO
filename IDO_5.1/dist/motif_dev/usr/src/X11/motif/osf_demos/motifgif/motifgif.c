...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: motifgif.c,v $ $Revision: 1.3 $ $Date: 1993/01/12 21:58:34 $"
#endif
#endif
...
#ifdef __sgi
  XtAddCallback (widget, XmNokCallback, (XtCallbackProc)FileSelectOK, NULL);
#else /* OSF original */
...
CreateMenuBar ()
{
    ...
    */
    ...
    XtAddCallback (Label1A, XmNactivateCallback, (XtCallbackProc)MenuQuit, NULL);
    Label2A = CreatePushButton ("Show Files",'1',PullDown2);
    XtAddCallback (Label2A, XmNactivateCallback, (XtCallbackProc)ShowFiles, NULL);
#else /* OSF original */
    Label1A = CreatePushButton ("Quit",'1',PullDown1);
