...
#define	_XKB_H_
     ...
     *  -  requstMinor field of some events
     */
...
#define	X_kbGetButtonActions		24
#define	X_kbSetButtonActions		25
...
#define	XkbButtonActionsNotify		11
...
#define	XkbButtonActionsNotifyMask	(1L << 11)
#define	XkbAllEventsMask		(0x0FFF)

    /*
     * Slow keys states:
     *  - The 'slowKeyState' field of SlowKeyNotify events reports the
     *    current state of the slow key.
     */
...
#define	XkbSK_Release			3
    ...
    /*
     * Slow keys state masks:
     * - Used as an event detail mask to limit the conditions under which
     *   SlowKeyNotify events are reported
     */
...
#define	XkbAX_AllOptionsMask	(0x7FF)
...
#define	XkbGBN_ControlsMask		(1L << 7)
...
#define	XkbPCF_AllFlagsMask		(0x7)
