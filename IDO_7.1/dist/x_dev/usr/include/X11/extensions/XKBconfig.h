...
/* $XConsortium: xkbconfig.h,v 1.1 94/04/02 17:08:55 erik Exp $ */
/************************************************************
...
#define	XkbCF_InitialMods		(1<<0)
#define	XkbCF_InternalMods		(1<<1)
#define	XkbCF_IgnoreLockMods		(1<<2)
#define	XkbCF_InitialCtrls		(1<<3)
#define	XkbCF_AccessXTimeout		(1<<4)
#define	XkbCF_AccessXTimeoutCtrlsOn	(1<<5)
#define	XkbCF_AccessXTimeoutCtrlsOff	(1<<6)
#define	XkbCF_AccessXTimeoutOptsOn	(1<<7)
#define	XkbCF_AccessXTimeoutOptsOff	(1<<8)
#define	XkbCF_GroupsWrap		(1<<9)
