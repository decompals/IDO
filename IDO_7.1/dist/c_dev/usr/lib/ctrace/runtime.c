...
#ident	"$Header: /hosts/bonnie/proj/irix6.4-ssg/isms/cmplrs/ctrace/RCS/runtime.c,v 1.1 1993/09/16 19:16:54 sanjoy Exp $"
...
/* In BSD, handlers return int */
int
#else
/* In otherwise handlers return nothing */
void
#endif
f_ct_()
{
