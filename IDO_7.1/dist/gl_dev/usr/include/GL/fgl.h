...
C  SGIX_impact_pixel_texture 
       integer*4   GL_PIXEL_TEX_GEN_DISABLE_SGIX
       parameter ( GL_PIXEL_TEX_GEN_DISABLE_SGIX = 33154 ) 	
       integer*4   GL_PIXEL_TEX_GEN_ENABLE_SGIX
       parameter ( GL_PIXEL_TEX_GEN_ENABLE_SGIX = 33155 ) 	
