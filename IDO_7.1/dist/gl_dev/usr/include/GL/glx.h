...
extern int glXQueryChannelDeltasSGIX (Display *display, int screen, int channel, int *dx, int *dy, int *dw, int *dh);
extern int glXChannelRectSGIX (Display *display, int screen, int channel, int x, int y, int w, int h);
extern int glXQueryChannelRectSGIX (Display *display, int screen, int channel, int *x, int *y, int *w, int *h);
