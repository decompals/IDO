...
<!ENTITY	gloss.left-indent	CDATA	"32"	>
...
<!ENTITY	note.first-indent	CDATA	"-=42"	>
...
<style name="BULLET,TABLE,ROW,CELL">
	<left-indent>	if(eq(cnum(),1),32,int(add(32,mult(1.30,attr(LEFT)))))	</>
...
<style name="CELL">
	<left-indent>	if(eq(cnum(),1),12,int(mult(1.35,attr(LEFT))))	</>
	<width>	int(mult(1.30,attr(WIDTH)))	</>
	<column>	True	</>
</style>
...
<style name="HANGBODY,TABLE,ROW,CELL">
	<left-indent>	if(eq(cnum(),1),102,int(add(102,mult(1.30,attr(LEFT)))))	</>
	<width>	int(mult(1.30,attr(WIDTH)))	</>
	<column>	True	</>
</style>
...
<style name="HARDWARELABEL">
	...
	<hide>	Text	</>
	<script>	ebt-reveal  stylesheet=fulltext.v width=300 height=15 title="Advanced Topic"	</>
	<icon-type>	advance	</>
</style>
...
<style name="TABLEXREF">
	<foreground>	&hot-link.color	</>
	<vertical-offset>	4	</>
	<script>	ebt-link root=idmatch(ID,attr(IDREF)) window=new	</>
	<text-after> </>
</style>
...
<style name="TRYTHIS">
	...
	<break-before>	None	</>
	<break-after>	None	</>
	<script>	ebt-reveal  stylesheet=fulltext.v width=300 height=15 title="Try This"	</>
	<icon-type>	tryme	</>
</style>
