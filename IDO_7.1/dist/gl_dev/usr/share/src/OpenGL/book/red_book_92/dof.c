...
void accFrustum(GLdouble left, GLdouble right, GLdouble bottom, 
    GLdouble top, GLdouble nearZ, GLdouble farZ, GLdouble pixdx, 
    GLdouble pixdy, GLdouble eyedx, GLdouble eyedy, GLdouble focus)
{
    ...
    dx = -(pixdx*xwsize/(GLdouble) viewport[2] + eyedx*nearZ/focus);
    dy = -(pixdy*ywsize/(GLdouble) viewport[3] + eyedy*nearZ/focus);
...
void accPerspective(GLdouble fovy, GLdouble aspect, 
    GLdouble nearZ, GLdouble farZ, GLdouble pixdx, GLdouble pixdy, 
    GLdouble eyedx, GLdouble eyedy, GLdouble focus)
{
    ...
    top = nearZ / (cos(fov2) / sin(fov2));
    bottom = -top;

    right = top * aspect;
    left = -right;

    accFrustum (left, right, bottom, top, nearZ, farZ,
