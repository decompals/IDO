...
*  
*  $Author: blean $
*  $Source: /hosts/bonnie/proj/banyan/isms/motif/src/lib/Sgm/RCS/GraphP.h,v $
*  $Revision: 1.4 $
*  $Date: 1994/11/12 01:47:37 $
*
*******************************************************************************
*/
...
#ifdef NEVER /* this needs to be a widget class pointer, not an int */
...
/* Internal routines needed elsewhere in the library */
extern Boolean _SgGraphArcInRect (Widget arc, XRectangle *rect);
extern void    _SgGraphSetupArcInternal (Widget graph, Widget arc);
