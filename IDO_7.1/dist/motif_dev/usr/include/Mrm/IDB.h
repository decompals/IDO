 ...
 * Motif Release 1.2.4
*/ 
/*   $RCSfile: IDB.h,v $ $Revision: 1.5 $ $Date: 1994/05/03 23:45:30 $ */
...
typedef union {
	...
	unsigned long		pointer ;	/* the pointer as a value */
#else /* SGI upgrade for 64-bits */
	/*
	 * 5/3/94 -- Scott Meeks @ OSF says the maintainer of this code
	 *	     says it doesn't ever hold a real pointer.
	 */
	CARD32			pointer ;	/* the pointer as a value */
#endif /* __sgi */
	struct {
...
#else /* SGI upgrade for 64-bits */
/* Match the  IDBDataPointer.pointer declaration */
typedef	CARD32		IDBDataHandle ;
#endif /* __sgi */
...
/*
 * IDBLowLevelFile struct is defined in Mrm.h
 */
