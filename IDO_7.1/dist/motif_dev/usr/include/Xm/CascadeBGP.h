 ...
 * Motif Release 1.2.4
*/ 
/*   $RCSfile: CascadeBGP.h,v $ $Revision: 0.5 $ $Date: 1995/01/10 02:02:32 $ */
/*
...
typedef struct __SG_XmCascadeBGClassExtPArt
{
  visual_state_array cascade_state_array;
}_SG_XmCascadeBGClassExtPart;

typedef struct __SG_XmCascadeBGClassExt
{
  _SgClassExtensionRec common;
  _SG_XmCascadeBGClassExtPart cascadebg;
}_SG_XmCascadeBGClassExtRec, *_SG_XmCascadeBGClassExt;
...
#define _SG_CascadeBGClassPtr(wc) \
((_SG_XmCascadeBGClassExt)(((XmCascadeButtonGadgetClassRec*)(wc))-> \
			   cascade_button_class._SG_vendorExtension))
