 ...
 * Motif Release 1.2
*/ 
/*   $RCSfile: TextFP.h,v $ $Revision: 0.6 $ $Date: 1995/01/10 02:12:04 $ */
/*
...
typedef struct __SG_XmTextFieldExtPart
  {
  ...
  } _SG_XmTextFieldExtPart;

typedef struct __SG_XmTextFieldExt
  {
    _SgInstanceExtensionRec	common;   /* Stuff all instance rec's have */
    _SG_XmTextFieldExtPart	rsrc;	  /* Resources & instance var's */
  } _SG_XmTextFieldExtRec, *_SG_XmTextFieldExt;

#define _SG_TextFieldPtr(w) \
((_SG_XmTextFieldExt)(((XmTextFieldWidget)(w))->text._SG_vendorExtension))
...
#ifdef sgi
/* Allow future extensions without breaking shared library compatibility */
    _SG_XmTextFieldExt _SG_vendorExtension;
#endif /* sgi */
  }
  XmTextFieldPart;
