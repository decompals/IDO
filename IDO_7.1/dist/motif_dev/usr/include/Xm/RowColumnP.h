 ...
 * Motif Release 1.2.3
*/ 
/*   $RCSfile: RowColumnP.h,v $ $Revision: 0.4 $ $Date: 1995/01/10 02:08:32 $ */
/*
...
typedef struct __SG_XmRowColumnExt
{
  Window  btn_drop_shadow1;
  Window  btn_drop_shadow2;
  Widget  current_user;
}_SG_XmRowColumnExtPart;

typedef struct _SG_XmRowColumnExtStruct
{
  _SgInstanceExtensionRec     common; /* common stuff */
  _SG_XmRowColumnExtPart      instance; /*Resources & instance vars */
}_SG_XmRowColumnExtRec, *_SG_XmRowColumnExt;

#define _SG_RowColumnPtr(w) \
((_SG_XmRowColumnExt)(((XmRowColumnWidget)(w)) \
		      ->row_column._SG_vendorExtension))
...
/* Allow future extensions without breaking shared library compatibility */
    _SG_XmRowColumnExt  _SG_vendorExtension;
#endif /* __sgi */
} XmRowColumnPart;
