...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: DNDDemo.c,v $ $Revision: 1.3 $ $Date: 1994/07/08 18:34:14 $"
#endif
#endif
/*
...
#else /* CRAY bug report patch */
/* You really need the number of int's -- the arithmetic is not needed */
        *length = target_count;
#endif
        *format = 32;
...
#ifndef __sgi /* OSF original */
        *length = sizeof(Pixel);
#else /* SGI changes, from CRAY bug report */
        *length = sizeof(*rect)/sizeof(long);
#endif
        *format = 32;
