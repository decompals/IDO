...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: xmlist.c,v $ $Revision: 2.4 $ $Date: 1993/02/26 22:13:42 $"
#endif
#endif
/*
...
#ifdef OVERLAY_DEMO
/* put the entire demo in the overlay planes */
    i = 0;
    SG_getPopupArgs (display, NULL, Args, &i);
    toplevel = XtAppCreateShell(NULL, "XMdemos",
