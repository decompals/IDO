...
{ "_SGI_MMX_mwm_noclientwindowmem", "Insufficient memory for client window framing" },
{ "_SGI_MMX_mwm_readerr_title", "Error reading Title Elements\n" },
{ "_SGI_MMX_mwm_noiconputmem", "Insufficient memory for icon placement" },
{ "_SGI_MMX_mwm_nomem_icondata", "Insufficient memory to create icon box data" },
{ "_SGI_MMX_mwm_nomem_windata", "Insufficient memory for window management data" },
{ "_SGI_MMX_mwm_nomem_winflags", "Insufficient memory for window manager flags" },
{ "_SGI_MMX_mwm_nomem_atom", "Insufficient memory to XInternAtom _MOTIF_WM_QUERY_nn" },
{ "_SGI_MMX_mwm_ownfailed", "Failed to own _MOTIF_WM_QUERY_nn selection" },
{ "_SGI_MMX_mwm_nomem_winmgrdata", "Insufficient memory for window manager data" },
{ "_SGI_MMX_mwm_listsel", "Lost _MOTIF_WM_QUERY_nn selection" },
{ "_SGI_MMX_mwm_nomem_cvtsel", "Insufficient memory to convert _MOTIF_WM_QUERY_nn selection" },
...
{ "_SGI_MMX_mwm_badcvt", "mwm cannot convert property %.100s as clientTitle/iconTitle: XmbTextPropertyToTextList." },
{ "_SGI_MMX_mwm_nomem_cvt", "insufficient memory to convert property %.100s as clientTitle/iconTitle: XmbTextPropertyToTextList." },
{ "_SGI_MMX_mwm_unknown_prop", "mwm receives unknown property as clientTitle/iconName %.100s property ignored." },
...
{ "_SGI_MMX_mwm_inconsis_variable", "ERROR: couldn't get a consistent set of visuals\n" },
{ "_SGI_MMX_mwm_no_keybind", "Key bindings %s not found, using builtin key bindings\n" },
{ "_SGI_MMX_mwm_no_btnbind", "Button bindings %s not found, using builtin button bindings\n" },
...
{ "_SGI_MMX_mwm_nomem_LANG", "Insufficient memory to get LANG environment variable." },
...
{ "_SGI_MMX_mwm_nomem_accspec", "Insufficient memory for accelerator specification" },
...
{ "_SGI_MMX_mwm_nomem_btnspec", "Insufficient memory for button specification" },
...
{ "_SGI_MMX_mwm_parser4", "%s: %s on line %d of configuration file \"%s\"\n" },
{ "_SGI_MMX_mwm_parser5", "%s: %s on line %d of specification string\n" },
{ "_SGI_MMX_mwm_visual1", "SG_visualType \"%s\" contains a non-alphabetic character \"%c\"." },
{ "_SGI_MMX_mwm_visual2", "Using \"%s\" instead." },
{ "_SGI_MMX_mwm_nouplane", "underlay planes not supported from X11" },
{ "_SGI_MMX_mwm_noreq_visual", "Unable to get requested visualType (%s) with visualDepth (%d)." },
{ "_SGI_MMX_mwm_visual3", "Setting visual resources to server default values." },
{ "_SGI_MMX_mwm_visual4", "Using visualType \"%s\" & visualDepth \"%d\" instead." },
...
static
#endif /* SG_IS_STATIC */
void LoadIntlResources( w, substr, Substr )
	Widget w;
	char *substr;
	char *Substr;
{
	...
	XtGetSubresources( w, AppDataPtr, substr, Substr,
		resources, n, NULL, 0 );
