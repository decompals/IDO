...
MyWindow::MyWindow( const char *name) : VkSimpleWindow( name)
{
    ...
    _optionMenu = new VkOptionMenu(rc, "optionMenu");
    _optionMenu->addAction("Red",   &MyWindow::sampleCallback, (XtPointer) this);
    _optionMenu->addAction("Green", &MyWindow::sampleCallback, (XtPointer) this);
    _optionMenu->addAction("Blue",  &MyWindow::sampleCallback, (XtPointer) this);
