...
struct PrintString PrintTable[] =
{
    ...
    { DM_IMAGE_PACKING, DM_PACKING_RGB,         "24-bit RGB"    },
    { DM_IMAGE_PACKING, DM_PACKING_RGBX,        "32-bit RGBX"   },
    { DM_IMAGE_PACKING, DM_PACKING_RGBA,        "32-bit RGBA"   },
    { DM_IMAGE_PACKING, DM_PACKING_RGB332,      "RGB-332"       },
    { DM_IMAGE_PACKING, DM_PACKING_RGB8,        "RGB-8" },
    { DM_IMAGE_PACKING, DM_PACKING_GRAYSCALE,   "8-bit Grayscale"},
    { DM_IMAGE_PACKING, DM_PACKING_YUV,         "24-bit YUV"    },
    { DM_IMAGE_PACKING, DM_PACKING_YUV411,      "YUV-411"       },
    { DM_IMAGE_PACKING, DM_PACKING_YUV422,      "YUV-422"       },
