...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: xgifload.c,v $ $Revision: 1.4 $ $Date: 1993/01/12 21:58:40 $"
#endif
#endif
/*
...
/* Allocate the X Image */
    ...
    theImage = XCreateImage(theDisp,theVisual,8,ZPixmap,0,(char *)Image,
...
#ifdef __sgi
    /*
     * This should really be a void function.
     * However, minimum change to OSF code is to just return an int.
     */
    if (!HasColormap) return 0;
#else /* OSF original */
