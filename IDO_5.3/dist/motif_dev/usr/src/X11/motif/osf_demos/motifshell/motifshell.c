...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: motifshell.c,v $ $Revision: 1.5 $ $Date: 1994/07/06 19:55:57 $"
#endif
#endif
...
#ifndef __sgi /* SGI does not have this program */
...
#ifdef __sgi
/* The keysyms are needed to for call to XmVaCreateMenuBar() */
static KeySym menuMnemonic[] = { (KeySym)'F', (KeySym)'O', (KeySym)'D', (KeySym)'U', (KeySym)'X', (KeySym)'F', (KeySym)'H' };
#endif /* __sgi */
...
#ifdef __sgi /* SGI does not have "Kaleidescope" */
    { "Xclock", "Xload"},
#else /* OSF original */
...
#else /* SGI 64-bit fix */
/*
 * The third parameter *must* be a keysym, not a character.
 * Otherwise this core dumps in 64 bits.
 */
	XmVaCASCADEBUTTON, s[0] = XmStringCreateSimple(menuString[0]), menuMnemonic[0],
	XmVaCASCADEBUTTON, s[1] = XmStringCreateSimple(menuString[1]), menuMnemonic[1],
	XmVaCASCADEBUTTON, s[2] = XmStringCreateSimple(menuString[2]), menuMnemonic[2],
	XmVaCASCADEBUTTON, s[3] = XmStringCreateSimple(menuString[3]), menuMnemonic[3],
	XmVaCASCADEBUTTON, s[4] = XmStringCreateSimple(menuString[4]), menuMnemonic[4],
	XmVaCASCADEBUTTON, s[5] = XmStringCreateSimple(menuString[5]), menuMnemonic[5],
	XmVaCASCADEBUTTON, s[6] = XmStringCreateSimple(menuString[6]), menuMnemonic[6],
#endif /* __sgi */
	NULL);
