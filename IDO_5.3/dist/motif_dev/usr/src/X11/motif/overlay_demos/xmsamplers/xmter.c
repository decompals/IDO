...
#ifdef REV_INFO
#ifndef lint
static char rcsid[] = "$RCSfile: xmter.c,v $ $Revision: 2.4 $ $Date: 1993/02/26 22:13:53 $"
#endif
#endif
/***************************************************************************
*  Xmter.
...
#ifdef OVERLAY_DEMO
/*
 * Note that the display was never explicitly found,
 * since XtAppInitialize was used.
 */
        n = 0;
        SG_getPopupArgs (XtDisplay(toplevel), NULL, args, &n);
