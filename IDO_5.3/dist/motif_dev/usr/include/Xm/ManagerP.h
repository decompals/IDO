 ...
 * Motif Release 1.2.4
*/ 
/*   $RCSfile: ManagerP.h,v $ $Revision: 0.4 $ $Date: 1994/06/19 22:23:26 $ */
/*
...
typedef struct __SG_XmManagerClassExtPart
{
  XmRenderShadowsProc render_shadows;
  visual_state_array  default_state_array;
}_SG_XmManagerClassExtPart;

typedef struct __SG_XmManagerClassExt
{
  _SgClassExtensionRec common;
  _SG_XmManagerClassExtPart manager;
} _SG_XmManagerClassExtRec, *_SG_XmManagerClassExt;
...
#ifdef __sgi /* Specify SGI  Manager instance record extension */
typedef struct __SG_XmManagerExtPart
{
  visual_state_array instance_state_array;
  int    visual_state;
  shaderptr shader;
  Boolean draw_frame;
  Boolean draw_internal_frame;
} _SG_XmManagerExtPart;

 typedef struct __SG_XmManagerExt
{
  _SgInstanceExtensionRec     common;   /* Stuff all instance rec's have */
  _SG_XmManagerExtPart      instance;
} _SG_XmManagerExtRec, *_SG_XmManagerExt;

#define _SG_ManagerPtr(w) \
((_SG_XmManagerExt)(((XmManagerWidget)(w))->manager._SG_vendorExtension))

#define _SG_ManagerClassPtr(wc) \
((_SG_XmManagerClassExt)(((XmManagerClassRec*)(wc))-> \
			    manager_class._SG_vendorExtension))
#endif /* __sgi */
...
#ifdef __sgi
/* Allow future extensions without breaking shared library compatibility */
   _SG_XmManagerExt _SG_vendorExtension;
#endif /* __sgi */
} XmManagerPart;
