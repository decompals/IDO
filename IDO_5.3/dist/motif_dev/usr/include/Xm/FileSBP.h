 ...
 * Motif Release 1.2.3
*/ 
/*   $RCSfile: FileSBP.h,v $ $Revision: 0.9 $ $Date: 1994/09/02 22:47:30 $ */
/*
...
/* Access Macros */
#define FSB_Finder( w )  (((_SG_XmFileSelectionBoxExt)(((XmFileSelectionBoxWidget)(w))->file_selection_box._SG_vendorExtension))->rsrc.finder)
#define FSB_FilterDialog( w )  (((_SG_XmFileSelectionBoxExt)(((XmFileSelectionBoxWidget)(w))->file_selection_box._SG_vendorExtension))->rsrc.filterDialog)
#define FSB_WaitCursor( w )  (((_SG_XmFileSelectionBoxExt)(((XmFileSelectionBoxWidget)(w))->file_selection_box._SG_vendorExtension))->rsrc.waitCursor)
#define FSB_NormalCursor( w )  (((_SG_XmFileSelectionBoxExt)(((XmFileSelectionBoxWidget)(w))->file_selection_box._SG_vendorExtension))->rsrc.normalCursor)
#define FSB_useEnhanced( w )  (((_SG_XmFileSelectionBoxExt)(((XmFileSelectionBoxWidget)(w))->file_selection_box._SG_vendorExtension))->rsrc.use_enhanced_fsb)
