 ...
 * Motif Release 1.2.4
*/ 
/*   $RCSfile: GadgetP.h,v $ $Revision: 0.4 $ $Date: 1994/06/19 22:23:26 $ */
/*
...
typedef struct __SG_XmGadgetClassExtPart
{
  XmRenderShadowsProc render_shadows;
  visual_state_array  default_state_array;
}_SG_XmGadgetClassExtPart;
  
typedef struct __SG_XmGadgetClassExt
{
  _SgClassExtensionRec common;
  _SG_XmGadgetClassExtPart gadget;
} _SG_XmGadgetClassExtRec, *_SG_XmGadgetClassExt;
...
#endif
#ifdef __sgi /* Specify SGI  Gadget instance record extension */

typedef struct __SG_XmGadgetExtPart
  {
 ...
 typedef struct __SG_XmGadgetExt
{
  _SgInstanceExtensionRec     common;   /* Stuff all instance rec's have */
  _SG_XmGadgetExtPart         gadget; /* Resources & instance var's */
}_SG_XmGadgetExtRec, *_SG_XmGadgetExt; 

#define _SG_GadgetPtr(w) \
((_SG_XmGadgetExt)(((XmGadget)(w))->gadget._SG_vendorExtension))

#define _SG_GadgetClassPtr(wc) \
((_SG_XmGadgetClassExt)(((XmGadgetClassRec*)(wc))->\
			   gadget_class._SG_vendorExtension))
#endif 
...
#ifdef __sgi
/* Allow future extensions without breaking shared library compatibility */
   _SG_XmGadgetExt  _SG_vendorExtension;
#endif /* __sgi */
} XmGadgetPart;
