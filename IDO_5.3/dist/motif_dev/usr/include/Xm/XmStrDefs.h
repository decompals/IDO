 ...
 * Motif Release 1.2.4
*/ 
/*   $RCSfile: XmStrDefs.h,v $ $Revision: 0.11 $ $Date: 1994/06/19 22:36:27 $ */
/*
...
#ifdef __sgi
/*
 * Motif 1.2.3 broke compile-time behavior unnecessarily -- which should
 * not happen in a patch release.
 *
 * It is entirely reasonable for a program to include this file to get
 * some string definitions, without also including Xm.h.  Such a program
 * is broken by the change of 'extern' to 'externalref'.  This would have
 * been no problem if X11/Intrinsic.h has been included instead of assuming
 * that Xm.h would be there to supply it.
 */
