 ...
 * Motif Release 1.2.3
*/ 
/*   $RCSfile: LabelP.h,v $ $Revision: 0.5 $ $Date: 1994/06/19 22:23:26 $ */
/*
...
#ifdef __sgi /* Specify SGI Label instance record extension */

  typedef struct __SG_XmLabelExtPart
  {
    Boolean			draw_label_frame;
    unsigned char               shadow_type;
  } _SG_XmLabelExtPart;

  typedef struct __SG_XmLabelExt
  {
    _SgInstanceExtensionRec	common;   /* Stuff all instance rec's have */
    _SG_XmLabelExtPart	rsrc;	  /* Resources & instance var's */
  } _SG_XmLabelExtRec, *_SG_XmLabelExt;

#define _SG_LabelPtr(w) \
((_SG_XmLabelExt)(((XmLabelWidget)(w))->label._SG_vendorExtension))
...
#ifdef __sgi
/* Allow future extensions without breaking shared library compatibility */
	_SG_XmLabelExt _SG_vendorExtension;
#endif /* __sgi */
} XmLabelPart;
