 ...
 * Motif Release 1.2.1
*/ 
/*   $RCSfile: ToggleBGP.h,v $ $Revision: 0.5 $ $Date: 1993/12/09 00:04:53 $ */
/*
...
#ifdef __sgi /* Specify SGI ToggleGadget instance record extension */
typedef struct __SG_XmToggleGadgetExtPart
{
...
}_SG_XmToggleGadgetExtPart;

typedef struct __SG_XmToggleGadgetExt
{
  _SgInstanceExtensionRec     common;   /* Stuff all instance rec's have */
  _SG_XmToggleGadgetExtPart   instance; /* Resources & instance var's */
} _SG_XmToggleGadgetExtRec, *_SG_XmToggleGadgetExt;

#define _SG_ToggleGadgetPtr(w) \
((_SG_XmToggleGadgetExt)(((XmToggleButtonGadget)(w))->toggle._SG_vendorExtension))
...
{ 
   ...
   XmToggleButtonGCacheObjPart  *cache; /* Replace cache instance fields */
					/* with a pointer */
#ifdef __sgi /* Allow future extensions without breaking shared library compatibility */
   _SG_XmToggleGadgetExt _SG_vendorExtension;
#endif /* __sgi */
