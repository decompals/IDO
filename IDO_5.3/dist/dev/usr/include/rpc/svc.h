...
#ifdef _KERNEL
	/* Used to have socket pointer here */
...
/*
 * Kernel UDP-based rpc (for NFS only)
 */
extern SVCXPRT *svckudp_create(u_short);
extern void svckudp_destroy(SVCXPRT   *xprt);

/* RPC internal error codes */
#define NFS_RPC_OK 0
#define NFS_RPC_PROC 1
#define NFS_RPC_VERS 2
#define NFS_RPC_DECODE 3
#define NFS_RPC_AUTH 4
