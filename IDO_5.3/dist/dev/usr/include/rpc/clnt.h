...
extern int	getport_loop(struct sockaddr_in *, u_long, u_long, u_long);
...
extern struct mbuf *ku_recvfrom(struct socket *, struct sockaddr_in *,
				struct mac_label **);
extern struct mbuf     *mclgetx(int (*dfun)(), long, int (*ffun)(),
			long, caddr_t, int, int);
extern int	bindresvport(struct socket *);
extern void	bootp_cleanup(CLIENT **);
