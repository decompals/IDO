 ...
 *  to use fonts and print things in a window.
 *
...
XFontStruct *font_info;
{
   char *string1 = "A different kind of font";
   char *string2 = "Press any key to quit.";
   int len1,len2;
...
/*Output text centered in window width */
   ...
   XDrawString(display,win,gc,30,60,string2,len1);
}
