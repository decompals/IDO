...
static void
put_paper_plane(float *source, perfobj_t *pobj)
{
    int             j;
...
static void
put_texture_bind(int bind, perfobj_t *pobj)
{
    unsigned long  *flagsptr = pobj->flags;
...
static void
put_clouds_vert(float s, float t, float x, float y, float z,
...
create_terrain(void)
{
    int             t, r, c, i, x1, y1, x2, y2;
    int             hillsize;

    fprintf(stderr, "initial terrain\n");
...
erode_terrain(void)
{
    ...
    fprintf(stderr, "eroding terrain\n");
...
init_cells(void)
{
    ...
    int             pntr, i, index, sstart, tstart;
    float           *D;
    perfobj_t	    *pobj;
...
static void
put_cell(float *source, perfobj_t *pobj)
{
    int             i, j;
    perfobj_vert_t *pdataptr =(perfobj_vert_t *) pobj->vdata;
    unsigned long  *flagsptr = pobj->flags;
