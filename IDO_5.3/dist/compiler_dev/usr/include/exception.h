 ...
 * |-----------------------------------------------------------|
 */
/* $Header: /proj/irix5.3/isms/cmplrs/commonlib/include/RCS/exception.h,v 7.7 1994/07/31 11:39:47 dlai Exp $ */
#ifndef _EXCEPTION_H
#define _EXCEPTION_H
...
#if (defined(_LANGUAGE_C) || defined(_LANGUAGE_C_PLUS_PLUS))
void
set_unhandled_exception(void (*  handler )(void (*)(long, long, struct
sigcontext *, struct sigcontext *, struct runtime_pdr *, long)));
